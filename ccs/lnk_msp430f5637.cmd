...
MEMORY
{
    ...
    FLASH                   : origin = 0x8000, length = 0x7B00

	LC1            		   	: origin = 0xFB00, length = 0x0100
    NOT                  	: origin = 0xFC00, length = 0x004E
    AND                   	: origin = 0xFC4E, length = 0x00B0
    LDR                   	: origin = 0xFD00, length = 0x0070
    RR                   	: origin = 0xFD70, length = 0x0090
    GETC                   	: origin = 0xFE00, length = 0x0070
    OUTC                   	: origin = 0xFE70, length = 0x0090
...
SECTIONS
{
   ...
   /* .LC1_Code 	:	LOAD=0x00FB00
    .NOT_Trap 	:	LOAD=0x00FC00
    .AND_Trap 	:	LOAD=0x00FC4E
    .LDR_Trap	:	LOAD=0x00FD00
    .RR_Trap	:	LOAD=0x00FD70
    .GETc_Trap	:	LOAD=0x00FE00
    .OUTc_Trap	:	LOAD=0x00FE70 */
...
//#endif
    ...
    .reset       : {}               > RESET  /* MSP430 RESET VECTOR         */ 
        ...
        /*Custom Sections for 220 project*/


    /*
    Original solution vector mapping
    .LC1_Code 	:	LOAD=0xFA00
    .NOT_Trap 	:	LOAD=0xFC00
    .AND_Trap 	:	LOAD=0xFC4E
    .LDR_Trap	:	LOAD=0xFCC0
    .RR_Trap	:	LOAD=0xFD00
    .GETc_Trap	:	LOAD=0xFE00
    .OUTc_Trap	:	LOAD=0xFE70
    */
}
